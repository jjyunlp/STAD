...
def run_one_self_training_base_merge_pseudo_data(python_file, dataset_name, exp_base_dir, cuda_num, max_label_num=1, method=None, batch_size=None):
    # dataset
    model_type = "bert"
    model_name_or_path = "../../bert-base-uncased"
...
def do_self_training():
    ...
    for max_label_num in max_label_nums:
        ...
        if train_merge_easy_and_hard_by_accumulate_prob:
            ...
            run_one_self_training_base_merge_pseudo_data(python_file, dataset_name, exp_base_dir, cuda_num, max_label_num=max_label_num, method=method)
...
def do_two_stage():
    ...
    for max_label_num in max_label_nums:
        ...
        if train_two_stage_easy_and_hard_to_gold:
            ...
            cmd = run_one_self_training_two_stage_fine_tune(
...
if __name__ == "__main__":
    ...
    if server == 'AI':
        exp_base_dir = f"/data/jjy/ST_RE_micro_accumurate_prob_{part}"
    dataset_name = "SemEval-2010-Task8"
    ...
    max_label_nums = [2, 4, 6]
    do_two_stage()

    print(f"SemEval2010 part: {part}")