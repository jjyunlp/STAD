...
we sum all loss for negative classes, after that, we avg it by 0's num.
"""
import random
import os
import numpy as np
...
for self_train_epoch in range(args.self_train_epoch):
    ...
    # Merge
    train_inst += (pseudo_hard_inst + pseudo_easy_inst)
    train_bert += (pseudo_hard_bert + pseudo_easy_bert)
