...
for self_train_epoch in range(args.self_train_epoch):
    ...
    first_train_inst = pseudo_easy_inst + pseudo_ambig_inst
    first_train_bert = pseudo_easy_bert + pseudo_ambig_bert
    ...
    if not os.path.exists(checkpoint):
        ...
        trainer.train(args, model, first_train_tensor, val_tensor, test_tensor,
    ...
    if not os.path.exists(checkpoint):
        logging.info("Start training model")
        trainer.train(args, model, second_train_tensor, val_tensor, test_tensor,
                      output_dir=checkpoint, use_random_subset=args.use_random_subset,
