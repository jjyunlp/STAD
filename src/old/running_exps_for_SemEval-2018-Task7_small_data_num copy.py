...
if __name__ == "__main__":
    ...
    if server == 'AI':
        exp_base_dir = f"/data/jjy/ST_RE_micro_small_data_0819_whole/"
    ...
    if train_merge_easy_example:
        ...
        run_one_self_training_base_merge_ambiguity_annotation_by_accumulate_prob(python_file, 
            dataset_name, exp_base_dir, cuda_num, prob_threshold, 2, method=method)
