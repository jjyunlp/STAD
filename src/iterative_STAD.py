...
"""
2022-10-16, Junjie Yu, Soochow University
Running the STAD and comparison systems iteratively.

Approaches
Teacher:
    supervised: human-annotated data as training data.
Student:
    self-training: human and confident data as training data.
