...
from data_processor.inst_to_example_converter import REDataProcessor, TextDataProcessor
...
# 看来原来用的是这个，直接注释，我们用BertModelOutCLS
...
data_processor = TextDataProcessor(args.dataset_name,
                                 args.train_file,
                                 args.val_file,
                                 args.test_file,
                                 args.label_file)
...
# Though REFeatureConverter will insert marker and get the index of marker, we can just use it and ignore the info of markers
