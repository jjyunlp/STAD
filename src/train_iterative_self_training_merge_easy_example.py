...
for self_train_epoch in range(args.self_train_epoch):
    ...
    # Merge
    merged_train_inst = train_inst + pseudo_easy_inst
    merged_train_bert = train_bert + pseudo_easy_bert
    ...
    train_feature = feature_converter.convert_examples_to_features(merged_train_bert, max_length=args.max_seq_length)
    train_tensor = tensor_converter.feature_to_tensor(train_feature)
