...
for self_train_epoch in range(args.self_train_epoch):
    ...
    if os.path.isfile(pseudo_select_file) and os.path.isfile(pseudo_unused_file):
        ...
        pseudo_unused_inst, pseudo_unused_bert = data_processor.get_examples_from_file_with_partial_by_prob(
            pseudo_unused_file, args.ambiguity_prob)
    else:
        ...
        # Only unused data need to been ambiguity
        pseudo_unused_bert = data_processor._create_examples_from_json_insert_entity_tag_with_partial_by_prob(pseudo_unused_inst, args.ambiguity_prob)
