...
negative training for ambiguous examples
positibr training for easy and gold examples
"""
import random
import os
import numpy as np
...
for self_train_epoch in range(args.self_train_epoch):
    ...
    if not os.path.exists(checkpoint):
        ...
        trainer.train_onehot(args, model, first_train_tensor, val_tensor, test_tensor,
                             ...
                             learning_rate=args.learning_rate, negative_training=True)
        logging.info("End Training.")
    ...
    if not os.path.exists(checkpoint):
        ...
        trainer.train_onehot(
                            ...
                            output_dir=checkpoint, use_random_subset=args.use_random_subset,
                            learning_rate=args.learning_rate_2, negative_training=False)   #
        logging.info("End Training.")
