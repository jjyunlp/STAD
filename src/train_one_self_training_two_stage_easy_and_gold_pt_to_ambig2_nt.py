...
for self_train_epoch in range(args.self_train_epoch):
    ...
    first_train_inst = train_inst + pseudo_easy_inst
    first_train_bert = train_bert + pseudo_easy_bert
    ...
    if not os.path.exists(checkpoint):
        ...
        trainer.train_onehot(args, model, first_train_tensor, val_tensor, test_tensor,
                             ...
                             learning_rate=args.learning_rate, negative_training=False)
        logging.info("End Training.")
    ...
    second_train_inst = pseudo_hard_inst
    second_train_bert = pseudo_hard_bert
    ...
    if not os.path.exists(checkpoint):
        ...
        trainer.train_onehot(
                            ...
                            output_dir=checkpoint, use_random_subset=args.use_random_subset,
                            learning_rate=args.learning_rate_2, negative_training=True)   #
        logging.info("End Training.")
